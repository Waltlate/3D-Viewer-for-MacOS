...
2. [Chapter II](#chapter-ii) \
    2.1. [Part 1](#part-1-3dviewer-v20) \
...
В данном проекте реализованно на языке программирования С++ в парадигме объектно-ориентированного программирования десктопное приложение для просмотра 3D моделей в каркасном виде.

## Chapter II

## Part 1. 3DViewer

3DViewer включает в себя:
...
- Классы должны быть реализованы внутри пространства имен `viewer`
